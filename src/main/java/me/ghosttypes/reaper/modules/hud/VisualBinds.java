...
public class VisualBinds extends HudElement {
    ...
    private final Setting<Sorter.SortMode> sortMode = sgGeneral.add(new EnumSetting.Builder<Sorter.SortMode>().name("sort-mode").description("How to sort the binds list.").defaultValue(Sorter.SortMode.Shortest).build());
    ...
    private void updateBinds() {
        ...
        if (sortMode.get().equals(Sorter.SortMode.Shortest)) {
