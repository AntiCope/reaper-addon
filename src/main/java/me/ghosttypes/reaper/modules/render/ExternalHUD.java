...
import me.ghosttypes.reaper.util.render.ExternalRenderers.ExternalFrame;
    ...
    public void onActivate() {
        ...
        EventQueue.invokeLater(() -> { // external frames must *always* be started this way
            if (externalFrame == null) {
                ...
                externalFrame = new ExternalFrame(width.get(), height.get(), "Reaper " + Reaper.VERSION, this);
            }
